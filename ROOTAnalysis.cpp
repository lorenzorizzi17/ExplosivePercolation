...
void plotSF(){
    ...
    TGraph *gr = new TGraph("./data/LCC/PRSF_gamma3.8_kmin2.txt");
    gr->SetTitle("Largest Cluster Size evolution; N. edges; LCC size");
    gr->SetMarkerStyle(20);
    gr->SetMarkerColor(kBlue+1);
    gr->SetLineColor(kBlue+1);
    ...
    TGraph *gr2 = new TGraph("./data/LCC/PRSF_gamma3.5_kmin2.txt");
    ...
    TGraph *gr3 = new TGraph("./data/LCC/PRSF_gamma2.6_kmin2.txt");
    ...
    TLine *line = new TLine(1/(4.21635-1), 0, 1/(4.21635-1), 1.1);
    line->SetLineColor(kRed+1);
    line->SetLineStyle(2);
    line->SetLineWidth(2);
    line->Draw("SAME");

    TLine *line2 = new TLine(1/(3.42-1), 0, 1/(3.42-1), 1.1);
    ...
    TGraph *gr4 = new TGraph("./data/LCC/PRSF_gamma2.2_kmin2.txt");
    gr4->SetMarkerStyle(23);
    ...
    //draw a legend
    TLegend *legend = new TLegend(0.15, 0.65, 0.4, 0.85);
    legend->AddEntry(gr, "gamma = 3.8", "lp");
    legend->AddEntry(gr2, "gamma = 3.4", "lp");
    legend->AddEntry(gr3, "gamma = 2.6", "lp");
    legend->AddEntry(gr4, "gamma = 2.2", "lp");
    legend->SetFillColorAlpha(kWhite, 0.8);
    legend->SetBorderSize(0);
    legend->SetTextSize(0.03);
    legend->Draw();
